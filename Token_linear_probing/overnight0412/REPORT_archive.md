...
**[모든 Phase 1 실험: pre-projection features 기준 (SigLip output, 1152-d)]**
...
**[모든 Phase 2 실험: pre-projection features 기준 (1152-d)]**
...
### Exp 2.3: F-stat distribution (pre-projection, delta 기준)
...
**[LLM hidden state 기준 — vision token이 LLM을 통과한 후 각 layer의 last token hidden state에서 probe. 3584-d.]**
